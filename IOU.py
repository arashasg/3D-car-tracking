...
if __name__ == '__main__':
    ...
    corners_3d_ground = get_3d_box((1, 1, 1), 0, (0.5,0.5, 0.5))
    # corners_3d_ground = np.array([[0,0,0],[0,1,0],[1,1,0],[1,0,0],[0,0,1],[0,1,1],[1,1,1],[1,0,1]])
    # corners_3d_predict = get_3d_box((1.458242, 1.604773, 3.707947), -1.549553, (2.756923, 1.661275, 20.943280))
    corners_3d_predict = corners_3d_ground - np.array([0.5,0.5,0.5]).reshape((1,3))
